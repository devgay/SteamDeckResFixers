...
# Assumes the player has DeusExe
...
export FILE="/home/deck/.steam/steam/steamapps/compatdata/6910/pfx/drive_c/users/steamuser/Documents/Deus Ex/System/DeusEx.ini"
...
DEUSEXE_SCALING_FIX=0

if [ $DECK_SCR_WIDTH -lt 1440 ] ; then
    DEUSEXE_SCALING_FIX=1
else
    DEUSEXE_SCALING_FIX=2
fi
...
sed -i "s/GUIScalingFix=.*/GUIScalingFix=$DEUSEXE_SCALING_FIX/" "$FILE"
