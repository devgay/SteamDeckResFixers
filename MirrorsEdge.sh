...
export FILE="/home/deck/.steam/steam/Steam/steamapps/compatdata/17410/pfx/drive_c/users/steamuser/Documents/EA\ Games/Mirror's Edge/TdGame/Config/TdEngine.ini"
...
sed -i "s/ResX=.*/ResX=$DECK_SCR_WIDTH/" "$FILE"
sed -i "s/ResY=.*/ResY=$DECK_SCR_HEIGHT/" "$FILE"
