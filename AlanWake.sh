...
export FILE="/home/deck/.local/share/Steam/steamapps/compatdata/108710/pfx/drive_c/users/steamuser/Documents/Remedy/AlanWake/resolution.xml"
...
sed -i "s/<width value=\".*/<width value=\"$DECK_SCR_WIDTH\"\/>/" "$FILE"
sed -i "s/<height value=\".*/<height value=\"$DECK_SCR_HEIGHT\"\/>/" "$FILE"
