...
export FILE="/run/media/deck/SteamDeckExtra/steamapps/common/HEAVY RAIN/user_setting.ini"
...
sed -i "s/Resolution=.*/Resolution=$DECK_SCR_WIDTH x $DECK_SCR_HEIGHT/" "$FILE"
