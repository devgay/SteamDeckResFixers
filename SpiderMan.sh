...
export FILE="/home/deck/.local/share/Steam/steamapps/compatdata/1817070/pfx/user.reg"
...
sed -i "s/\"FullscreenWidth\"=dword:00000.*/\"FullscreenWidth\"=dword:00000$(printf '%x\n' $(echo $DECK_SCR_WIDTH))/" "$FILE"
sed -i "s/\"FullscreenHeight\"=dword:00000.*/\"FullscreenHeight\"=dword:00000$(printf '%x\n' $(echo $DECK_SCR_HEIGHT))/" "$FILE"
