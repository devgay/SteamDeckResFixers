...
export FILE="/home/deck/.steam/steam/steamapps/compatdata/4000/pfx/user.reg"
...
sed -i "s/\"ScreenHeight\"=dword:.*/\"ScreenHeight\"=dword:00000$(printf '%x\n' $(echo $DECK_SCR_HEIGHT))/" "$FILE"
sed -i "s/\"ScreenWidth\"=dword:.*/\"ScreenWidth\"=dword:00000$(printf '%x\n' $(echo $DECK_SCR_WIDTH))/" "$FILE"
