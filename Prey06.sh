...
export FILE="/home/deck/.prey/base/preyconfig.cfg"
...
sed -i "s/seta r_windowWidth .*/seta r_windowWidth \"$DECK_SCR_WIDTH\"/" "$FILE"
sed -i "s/seta r_windowHeight .*/seta r_windowHeight \"$DECK_SCR_HEIGHT\"/" "$FILE"
sed -i "s/seta r_customWidth .*/seta r_customWidth \"$DECK_SCR_WIDTH\"/" "$FILE"
sed -i "s/seta r_customHeight .*/seta r_customHeight \"$DECK_SCR_HEIGHT\"/" "$FILE"
